...
<body>
    ...
    <div class="flex max-w-sm mx-auto overflow-hidden mt-10 mb-10 bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
        <div class="hidden bg-cover lg:block lg:w-1/2" style="background-image:url('https://image.shutterstock.com/image-vector/good-healthy-students-interested-fun-260nw-604678865.jpg')"></div>
